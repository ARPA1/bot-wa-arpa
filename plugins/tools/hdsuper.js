...
const pluginConfig = {
    name: ['zenithupscale', 'hdsuper', 'inhancer'],
    alias: [],
    category: 'tools',
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        await sock.sendMessage(m.chat, {
            image: buffers2,
            caption: `✨ *ᴢᴇɴɪᴛʜ ᴜᴘꜱᴄᴀʟᴇ*\n\n> Berhasil di-enhance menggunakan Zenith Upscale AI.`,
        }, { quoted: m })
