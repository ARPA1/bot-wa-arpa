...
const config = {
    ...
    info: {
        website: 'https://sc.zenith.my.id'
    },

    owner: {
        name: 'arpaa',                    // Nama owner
        number: ['6285174294370']         // Format: 628xxx (tanpa + atau 0)
    },

    session: {
        pairingNumber: '6285926394631',   // Nomor WA yang akan di-pair
        usePairingCode: true              //  true = Pairing Code, false = QR Code
    },

    bot: {
        name: 'Zenith 𝗠𝗗',                 // Nama bot
        version: '1.0.0',                 // Versi bot
        developer: 'arpa'          // Nama developer
    },
    ...
    sticker: {
        packname: 'Zeninth md',             // Nama pack sticker
        author: 'arpaa'                     // Author sticker
    },
    ...
    dev: {
        enabled: false,
        watchPlugins: false,    // Disable hot reload untuk performa lebih baik
    ...
    //  APIkey
    APIkey: {
        lolhuman: 'APIKey-Milik-Bot-Zeninth-md(arpaa)', // kalau limit habis bisa beli apikey di https://api.lolhuman.xyz/pricing
        neoxr: 'Milik-Bot-Zeninth-md',  // kalau limit habis bisa beli apikey di https://api.neoxr.eu/pricing
